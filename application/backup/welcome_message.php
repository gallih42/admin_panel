...
<html>
    <head>
        ...
        <!-- sweet alerts -->
        <link href="<?php base_url() ?>assets/assets/sweet-alert/sweet-alert.min.css" rel="stylesheet">
    ...
    <body class="fixed-left">
                    ...
                    <div class="container">
                        <div class="">
                            ...
                            <ul class="nav navbar-nav navbar-right pull-right">
                                ...
                                <li class="dropdown">
                                    <a href="" class="dropdown-toggle profile" data-toggle="dropdown" aria-expanded="true"><img src="<?php base_url() ?>assets/images/avatar-1.jpg" alt="user-img" class="img-circle"> </a>
            ...
            <div class="left side-menu">
                <div class="sidebar-inner slimscrollleft">
                    <div class="user-details">
                        <div class="pull-left">
                            <img src="<?php base_url() ?>assets/images/users/avatar-1.jpg" alt="" class="thumb-md img-circle">
                        </div>
                        <div class="user-info">
                            <div class="dropdown">
                                        ...
                                        <div class="inbox-widget nicescroll mx-box">
                                            <a href="#">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img"><img src="<?php base_url() ?>assets/images/users/avatar-1.jpg" class="img-circle" alt=""></div>
                                            ...
                                            <a href="#">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img"><img src="<?php base_url() ?>assets/images/users/avatar-2.jpg" class="img-circle" alt=""></div>
                                            ...
                                            <a href="#">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img"><img src="<?php base_url() ?>assets/images/users/avatar-3.jpg" class="img-circle" alt=""></div>
                                            ...
                                            <a href="#">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img"><img src="<?php base_url() ?>assets/images/users/avatar-4.jpg" class="img-circle" alt=""></div>
                                            ...
                                            <a href="#">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img"><img src="<?php base_url() ?>assets/images/users/avatar-5.jpg" class="img-circle" alt=""></div>
                                            ...
                                            <a href="#">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img"><img src="<?php base_url() ?>assets/images/users/avatar-6.jpg" class="img-circle" alt=""></div>
                                            ...
                                            <a href="#">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img"><img src="<?php base_url() ?>assets/images/users/avatar-8.jpg" class="img-circle" alt=""></div>
                                            ...
                                            <a href="#">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img"><img src="<?php base_url() ?>assets/images/users/avatar-9.jpg" class="img-circle" alt=""></div>
                                            ...
                                            <ul class="conversation-list nicescroll">
                                                <li class="clearfix">
                                                    <div class="chat-avatar">
                                                        <img src="<?php base_url() ?>assets/images/avatar-1.jpg" alt="male">
                                                        <i>10:00</i>
                                                    </div>
                                                ...
                                                <li class="clearfix odd">
                                                    <div class="chat-avatar">
                                                        <img src="<?php base_url() ?>assets/images/users/avatar-5.jpg" alt="Female">
                                                        <i>10:01</i>
                                                    </div>
                                                    <div class="conversation-text">
                                                        <div class="ctext-wrap">
                                                ...
                                                <li class="clearfix odd">
                                                    <div class="chat-avatar">
                                                        <img src="<?php base_url() ?>assets/images/users/avatar-5.jpg" alt="male">
                                                        <i>10:02</i>
                                                    </div>
                                                    <div class="conversation-text">
                                                        <div class="ctext-wrap">
        ...
        <script src="<?php base_url() ?>assets/assets/chat/moment-2.2.1.js"></script>
        <script src="<?php base_url() ?>assets/assets/jquery-sparkline/jquery.sparkline.min.js"></script>
        ...
        <!-- sweet alerts -->
        <script src="<?php base_url() ?>assets/assets/sweet-alert/sweet-alert.min.js"></script>
        <script src="<?php base_url() ?>assets/assets/sweet-alert/sweet-alert.init.js"></script>

        <!-- flot Chart -->
        <script src="<?php base_url() ?>assets/assets/flot-chart/jquery.flot.js"></script>
        <script src="<?php base_url() ?>assets/assets/flot-chart/jquery.flot.time.js"></script>
        <script src="<?php base_url() ?>assets/assets/flot-chart/jquery.flot.tooltip.min.js"></script>
        <script src="<?php base_url() ?>assets/assets/flot-chart/jquery.flot.resize.js"></script>
        <script src="<?php base_url() ?>assets/assets/flot-chart/jquery.flot.pie.js"></script>
        <script src="<?php base_url() ?>assets/assets/flot-chart/jquery.flot.selection.js"></script>
        <script src="<?php base_url() ?>assets/assets/flot-chart/jquery.flot.stack.js"></script>
        <script src="<?php base_url() ?>assets/assets/flot-chart/jquery.flot.crosshair.js"></script>

        <!-- Counter-up -->
        <script src="<?php base_url() ?>assets/assets/counterup/waypoints.min.js" type="text/javascript"></script>
        <script src="<?php base_url() ?>assets/assets/counterup/jquery.counterup.min.js" type="text/javascript"></script>
        
        <!-- CUSTOM JS -->
        <script src="<?php base_url() ?>assets/js/jquery.app.js"></script>

        <!-- Dashboard -->
        <script src="<?php base_url() ?>assets/js/jquery.dashboard.js"></script>

        <!-- Chat -->
        <script src="<?php base_url() ?>assets/js/jquery.chat.js"></script>

        <!-- Todo -->
        <script src="<?php base_url() ?>assets/js/jquery.todo.js"></script>
