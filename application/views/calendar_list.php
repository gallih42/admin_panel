            ...
            function(data){
                ...
                $('#calendar').fullCalendar({
                    header: {
                        ...
                        center: 'title',
                        right: 'month,basicWeel,basicDay'
                    },
                    ...
                    eventDrop: function(event, delta, revertFunc){
                        alert("titulo: " + event.title + " - id: " + event.id + " - fi: " + event.start.format() + " - ff: " + event.end.format());
                    }
                                            ...
                                            <div class="widget-body">
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                                        ...
                                                        <!-- checkbox -->
                                                        <div class="checkbox checkbox-success m-t-40">
